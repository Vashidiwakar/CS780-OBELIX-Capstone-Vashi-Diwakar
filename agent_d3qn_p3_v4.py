"""Dueling Double DQN agent for OBELIX — Phase 3 v4.
Evaluation-only: loads pretrained weights from weights.pth.
Key improvements over v3:
  - Much stronger sensor bias (10.0 IR, 5.0 forward, 3.0 sides)
  - Rotate 12 steps then FW 3 steps to physically clear wall
...
def policy(obs: np.ndarray, rng: np.random.Generator) -> str:
    ...
    # countdown recovery — last 3 steps force FW to physically clear wall
