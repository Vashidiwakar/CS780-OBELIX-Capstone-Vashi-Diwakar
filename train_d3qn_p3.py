"""Offline trainer: Dueling Double DQN — Phase 3 (moving + blinking box + wall).
...
Key improvements:
  - Three stage curriculum (d0 → d2 → d3)
...
Example:
  python train_d3qn_p3.py --obelix_py ./obelix.py --out weights_p3.pth --wall_obstacles
"""
...
def main():
    ...
    ap.add_argument("--out",             type=str,   default="weights_p3.pth")
    ap.add_argument("--episodes",        type=int,   default=4000)
    ap.add_argument("--max_steps",       type=int,   default=1000)
    ap.add_argument("--ep_switch1",      type=int,   default=1200)  # d0 → d2
    ...
    # create all three envs once outside loop
    env_d0 = OBELIX(
